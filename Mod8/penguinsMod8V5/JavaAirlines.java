...
public class JavaAirlines {
	...
	public static void makeRes(String[][][] f, ArrayList<Customer> cust, ArrayList<Reservation> reser) {
		...
		if (isCust == false) {
			...
			System.out.println(
					"There are currently no customers... You have to make one." + " Please follow the instructions!");
			c = createCust();
			cust.add(c);
		} else {
			boolean yes = false;
		...
		String[] seats = { "A1", "A2", "A3", "A4", "B3", "B4", "C3", "C4", "D3", "D4", "E3", "E4", "F3", "F4", "G3",
				"G4", "H1", "H2", "H3", "H4" };
	...
	public static int menu() {
		...
		System.out.println("\nPlease choose one of the following options from the menu:");
